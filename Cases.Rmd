...
### this is still the code of Typing
...
IPump$Type_1 %>% 
  ...
  geom_point(data = IPump$Type_1_avg, color = "red") +
  geom_smooth(data = IPump$Type_1_avg, method = "lm", color = "red")
...
write_sav(IPump$Type_1, "Data/IP_1.sav")
write_csv(IPump$Type_1, "Data/IP_1.csv")
