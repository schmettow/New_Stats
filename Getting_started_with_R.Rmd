...
```{r, opts.label = "rtut", results = "markup"}
...
```{r df_call_print, opts.label = "rtut.nr", results = "markup"}
print(Experiment)
...
```{r df_slicing, opts.label = "rtut", results = "markup"}
Experiment[  1, 3]
Experiment[1:3, 2]
Experiment[  1,  ]
```
...
```{r df_classic_odd, opts.label = "rtut", results = "markup"}
...
```{r df_injecting, opts.label = "rtut", results = "markup"}
## injecting
...
```{r opts.label = "table", results = "markup"}
ORPO %>% 
  filter(Task == 1, Item == 1) %>% 
  mascutils::discard_redundant()
```
