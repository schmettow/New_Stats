...
Two variable types apply in such cases: *factor* and *character*. While the first specializes on the purpose of grouping, character objects can also be used to store longer text, say the description of a usability problem.
