...
library(brms)
source("RMDR.R")
CE <- c("BrowsingAB", "Typing", "Uncanny", "CUE8", "Stroop", "Egan", "IPump")
load_CE(CE)
...
C_Egan_is_right
```
A chance of $`r Egan$C_Egan_is_right`$ can count as good evidence in favor of Egan's claim, although it is outshined by other factors, as we have discussed above. 
