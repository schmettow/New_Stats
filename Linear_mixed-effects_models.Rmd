...
16/02/03: simulation (rather than loading) of the Stroop data set
16/05/24: Typing data set added
16/08/11: started converting document to case environments and stan_lmer
...
* Neue Struktur
* überwiegend neue Inhalte
* CUE8 kann übernommen werden, 
* CUE8 anfüllen mit SPSS
* allein HF Beispiele 
* nur echte Datensätze
* außer BrowsingAB
