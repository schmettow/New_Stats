...
Occam's razor, or the  *parsimony principle*, is intuitive, because people reportedly assume things for their own grounds a lot. It seems fully in order to have a counter balance, a way to avoid seeing fake signals. Or staying with the original metaphor, a blade is needed that prunes  exuberant creativity of the researcher.
...
From this perspective, replacing p-values with information criteria seems like an obvious improvement, as it allows the researcher to choose from a much wider range of models, and if that does not suffice, one can always resort to LOO cross validation. 

So, should you do hypothesis testing with information criteria, and if so, how? Before I get to that, let me answer first to an implied question: Should you do hypothesis testing?
For everyone doing applied or practical design reseach the answer should be: Your research implies or even targets real costs, benefits and risks for real people. What you should do is exploring impact factors and quantify them. Use the methods based on estimates, as well as the language presented in PART II  of this book. Also, it often is easy to re-formulate the hypothesis into a quantitative research question.


<!--And, if you can, imply the potential costs  of the design, system, organization, training or intervention, you are testing. When you are in an early stage of your study design, it can be liberating to forget about the strictly experimental idea of comparing conditions. Perhaps, you do not even need another design.-->
...
If you are comparing two conditions derived from theory (or if your supervisor or editor "convinces" you to do hypothesis testing), information criteria definitely are an option, if you understand, what you are doing.
