...
The authors of Bayesian books and the various regression engines have different opinions on  what to report as center estimate and credibility limits in a coefficient table. Most seem to prefer the posterior mode or the median, only some use the mean. 
