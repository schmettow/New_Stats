...
To assess the quality of the model fit, it is recommended to check the distribution of residuals. With rstan_arm models, we can extract residuals as:
...
Now that we have seen how we can compare on one factor, we can extend the model to more factors. With linear  models, 
. observations are unambiguously grouped by some criterion.
