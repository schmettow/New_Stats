...
Uncanny$P_1 <-  posterior(Uncanny$M_1) 
Uncanny$P_1$parameter <- str_replace(Uncanny$P_1$parameter, "Intercept", "huMech_0")
Uncanny$P_1$fixef <- str_replace(Uncanny$P_1$fixef, "Intercept", "huMech_0")
Uncanny$P_1 <-  posterior(Uncanny$P_1) 
