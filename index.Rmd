...
As I already said in \@ref(classroom), roughly the first 50% of every chapter are essential to understand the ground rules and basic procedures. The rest is deepening understanding or is covering special cases. 

Chapter \@ref(lm) introduces the basics on single-predictor models during the first three sections, whereas sections \@ref(mpm) and \@ref are closer to real research situations, in all their complexity and weird things that can happen with multiple predictors. It is for a good  reason, that these three chapters 
