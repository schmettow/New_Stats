...
Table: (\#tab:likely-2)The maximum liklihood is the lowest rank of negatove log-likelihood values
...
Table: (\#tab:sec99-12)Frequentist 95 percent confidence intervals
