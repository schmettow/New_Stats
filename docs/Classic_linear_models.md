...
\hline
sigma\_resid & mean & 31.5\\
\hline
Intercept & median & 106.0\\
\hline
sigma\_resid & median & 31.3\\
\hline
Intercept & mode & 106.0\\
\hline
sigma\_resid & mode & 31.1\\
\hline
Intercept & lower & 99.9\\
\hline
sigma\_resid & lower & 27.5\\
\hline
Intercept & upper & 112.0\\
\hline
sigma\_resid & upper & 36.5\\
\hline
\end{tabular}
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-24-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-27-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/99_seconds_random_walk-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/99_seconds_post-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-29-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/BAB_G_eda_1-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-32-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-38-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-39-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-40-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-42-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-45-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/eda_anova-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/AUP_corr_predictors-1} 
...
### Posterior predictions [TBC]

Up to this point, we have solely interpreted coefficient tables. Very often, the research question  is how strong the response variable is associated with a certain condition (i.e., the "independent" variable). This strength of an effect is what the coefficient table tells.

Another way to look at the model is how well it fits the observations. In Bayesian regression models, *posterior predictions* are a simple, yet powerful concept to compare the fitted model with the original data. As [McElreath] points out, one should rather call them *retrodictions*, because they regard the real data one has, not the future. In yet another perspective they are  *idealized responses* and as such address both, present and future. 

A more formal understanding of predicted values can be gained by 

Remember that all statistical model assume that an observed value is somehow composed of a systematic (or structural) component and the error. All linear models assume that any observed value is a sum of a structural term and the error. That becomes most apparent, when writing a linear model in a slightly different form:
...
This predicted value is our best guess of how a person of age 45 would perform. But, the separation of an observation into predicted value and error remains just that: a guess under a certain amount of information. Like coefficients, predicted values are uncertain to some degree, but we are setting this aside for the moment. What we know for sure is the *observed value* . 
...
For most analysis based on predicted values, it is useful to just add the predictions of a model to the original data.
(Of course, it is crucial at this step, that the order of data has not been altered.)
...
Now we can extract predicted values for certain conditions, say all participants of age 45. What differs is the observed value, as this contains the influence of all random sources at the time of measuring. We will return to residuals in the next section. 
...
Apparently, the model is strongly biased. It predicts too long ToT for all the 45 year olds (In chapter [REF Interaction effects]) we will find out why this is so. Interestingly, the four cases also do not get the same predictions. On closer examination we observe that the lower the observation, the lower the predicted value. What happens here is related to the third term of the model specification. The error $\epsilon_i$ is not completely unconstrained, but follows the Normal distribution shape. This shape implies that extreme errors are less likely to occur. That is what the model is adjusting for. Most noticable on the third case in the table above, the estimation rather takes a slightly lower predicted value, than a too extreme error. We will return to this mechanism in chapter [REF shrinkage]. 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-70-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/resid_dist_1-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/resid_dist_2-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-78-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-81-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-82-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-84-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-86-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-88-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-89-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-90-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-93-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/BAB1_resid_age_1-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/glm_EDA_3-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/BAB_ia2-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/BAB_ia3-1} 
<!-- #67 -->
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/interaction_effects-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/interaction_effects-2} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/eda_headache-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/reading_expl_1-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/reading-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-116-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/Sleep_expl-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/Yerkes_Dodson_1-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/uncanny_valley-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-124-1} 
...
\includegraphics[width=0.66\linewidth]{Classic_linear_models_files/figure-latex/unnamed-chunk-130-1} 
