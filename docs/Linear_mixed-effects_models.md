...
Table: (\#tab:hugme-7)Correlation of scores between session 1 and 2 (point estimates)
...
Table: (\#tab:hugme-8)Random effects correlations with 95 percent credibility limits
...
Table: (\#tab:hugme-10)Random effects correlations with 95 percent credibility limits
...
Table: (\#tab:uncanny-10)Random effects correlations of a design-o-metric model with 95 percent credibility limits
