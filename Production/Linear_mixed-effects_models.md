...
\caption{(\#tab:hugme-7)Correlation of scores between session 1 and 2 (point estimates)}
\centering
\begin{tabular}[t]{l|r}
\hline
re\_factor & cor\\
...
\caption{(\#tab:hugme-8)Random effects correlations with 95 percent credibility limits}
\centering
...
\caption{(\#tab:hugme-10)Random effects correlations with 95 percent credibility limits}
\centering
\begin{tabular}[t]{l|l|l|r|r|r}
\hline
re\_factor & between & and & center & lower & upper\\
...
Table: (\#tab:uncanny-9)Data set with 6 variables, showing 8 of 7488 observations.

|  Obs|Part  |Item |Design |Session | response|
|----:|:-----|:----|:------|:-------|--------:|
| 1242|p1_05 |nE2  |3      |1       |   -0.967|
| 4566|p2_03 |nE6  |71     |3       |   -0.740|
| 4589|p2_03 |nE5  |8      |3       |   -0.258|
| 5252|p2_06 |nE4  |72     |1       |   -0.352|
| 5362|p2_06 |nE2  |73     |2       |   -0.705|
| 6506|p2_10 |nE2  |46     |2       |   -0.670|
| 7035|p2_12 |nE3  |14     |2       |   -0.567|
| 7345|p2_13 |nE1  |69     |2       |   -0.688|
...
\caption{(\#tab:uncanny-10)Random effects correlations of a design-o-metric model with 95 percent credibility limits}
\centering
\begin{tabular}[t]{l|l|l|r|r|r}
\hline
re\_factor & between & and & center & lower & upper\\
