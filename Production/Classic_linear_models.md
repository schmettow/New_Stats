...
\caption{(\#tab:mfm-2)A two-factorial model has one r4eference level and two differences}
\centering
...
\caption{(\#tab:headache-2)Comparing the coefficients of conidtional and unconditional multi-factorial models}
\centering
\begin{tabular}[t]{l|r}
\hline
fixef & M\_1\\
...
\caption{(\#tab:boolean-OR)Saturation and amplification are like Bolean Or and AND}
\centering
...
\caption{(\#tab:uncanny-4)Polynomial coefficient table with 95 percent credibility limits}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
parameter & center & lower & upper\\
